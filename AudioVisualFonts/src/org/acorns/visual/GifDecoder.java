...
public class GifDecoder {
 ...
 /**
  * Assumed transparent color
  */
 public static final Color TRANS = new Color(180, 180, 180, 255);
	...
	protected int lastBgColor = TRANS.getRGB(); // previous bg color
	...
	protected int lastDispose = 2;

	protected boolean transparency = true;//false; // use transparent color
		...
		if (lastDispose > 0) 
  {
       ...
       else lastRect = new Rectangle(ix, iy, iw, ih);
       ...
       if (lastDispose == 2) 
       {
            ...
            if (transparency) 
            {
                c = TRANS; // assume background is transparent
            } else 
            {
